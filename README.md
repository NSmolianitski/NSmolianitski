...
- Custom implementation of C++ containers: [Containers](https://github.com/NSmolianitski/Containers)
...
- Kubernetes cluster: [Services](https://github.com/NSmolianitski/Services)
